...
<div class="container">
	...
	<div class="row">
		<div class="col-xs-3">
			<h5><label>A payment of ${sessionScope.session_customerCancelBean.getTransaction().getAmount()}is credited to: 
			${sessionScope.session_customerCancelBean.getUser().getFirstName()}</label></h5>
		</div>
	</div>
</div>
</body>
